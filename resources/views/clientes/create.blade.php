                            ...
                            <div class="card-body">
                                <form action="/clients" method="POST">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required="required" class="form-control" name="nombre_cliente">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required="required" class="form-control" name="dui"> </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required="required" class="form-control" name="telefono_cliente">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" required="required" class="form-control" name="celular_cliente">
                                        </div>
                                    </div>
